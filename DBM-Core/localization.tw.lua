...
DBM_CORE_AUTO_ANNOUNCE_OPTIONS = {
	...
	stack					= "提示|cff71d5ff|Hspell:%d|h%s|h|r的堆疊層數",
}
...
DBM_CORE_AUTO_SOUND_OPTION_TEXT			= "當你中了$spell:%d時播放\"快跑啊\"音效"
DBM_CORE_AUTO_COUNTDOWN_OPTION_TEXT	= "為$spell:%d施放前播放倒計時音效"
DBM_CORE_AUTO_COUNTOUT_OPTION_TEXT	= "為$spell:%d持續結束前播放倒計時音效"
