...
DBM_CORE_AUTO_TIMER_OPTIONS = {
	target					= "显示|cff71d5ff|Hspell:%d|h%s|h|r减益计时",
	cast					= "显示|cff71d5ff|Hspell:%d|h%s|h|r施法计时",
	active					= "显示|cff71d5ff|Hspell:%d|h%s|h|r持续计时",
	cd					= "显示|cff71d5ff|Hspell:%d|h%s|h|r冷却计时",
	cdcount					= "显示|cff71d5ff|Hspell:%d|h%s|h|r计数冷却计时",
	next					= "显示下一次|cff71d5ff|Hspell:%d|h%s|h|r计时",
	nextcount					= "显示下一次|cff71d5ff|Hspell:%d|h%s|h|r计数计时",
...
DBM_CORE_AUTO_ANNOUNCE_OPTIONS = {
	...
	count					= "显示计数警报：|cff71d5ff|Hspell:%d|h%s|h|r",
	stack					= "警报|cff71d5ff|Hspell:%d|h%s|h|r的堆叠层数",
}
...
DBM_CORE_AUTO_SOUND_OPTION_TEXT			= "为$spell:%d播放“快跑啊！”警报音效"
DBM_CORE_AUTO_COUNTDOWN_OPTION_TEXT	= "为$spell:%d施放前播放倒计时音效"
DBM_CORE_AUTO_COUNTOUT_OPTION_TEXT	= "为$spell:%d持续结束前播放倒计时音效"
