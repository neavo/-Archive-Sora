...
L:SetWarningLocalization({
	...
	WarnRemainingAdds		= "剩餘 %d 烈焰之子",
	warnAggro				= "你是熔火元素的目標",
	warnNoAggro				= "你不是熔火元素的目標",
...
L:SetOptionLocalization({
	...
	WarnRemainingAdds	= "在轉換階段顯示烈焰之子剩餘數量",
	ElementalAggroWarn	= "警告自身是否成為熔火元素的目標",
	...
	P4IconRangeFilter			= "第4階段的距離監視框僅顯示有團隊標記的隊員\n(需開啟距離監視框)",
	RangeFrame			= "顯示距離監視框",
