...
local function BuildExpBar(BottomFrame)
	...
	Bar.Text:SetFont(DB.Font, 9, "THINOUTLINE")
	Bar.Text:SetAlpha(0)
	...
	Bar.R:SetStatusBarTexture(DB.Statusbar)
	...
	Bar.R.BG:SetTexture(DB.Statusbar)
...
local function BuildBottomFrame()
	...
	BottomFrame:SetBackdrop({edgeFile = DB.Solid, edgeSize = 1})
