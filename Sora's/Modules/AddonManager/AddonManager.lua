...
local Module = Sora:NewModule("AddonManager")
...
local function BuildGameMenuButton(Tittle)
	...
	S.Reskin(Button)
	Button:SetSize(GameMenuButtonKeybindings:GetWidth(), GameMenuButtonKeybindings:GetHeight())
	Button:SetText("插件管理")
	Button:SetPoint("TOP", GameMenuButtonKeybindings, "BOTTOM", 0, -1)
	Button:SetScript("OnClick", function()
		HideUIPanel(GameMenuFrame)
		UpdateAddonList()
		Tittle:Show()
	end)
	GameMenuButtonMacros:SetPoint("TOP", Button, "BOTTOM", 0, -1)
...
local function BuildMainFrame()
	...
	function MainFrame.UpdatePageText() Bottom.Text:SetText("第 "..Page.." 页 / 共 "..MaxPage.." 页") end
	Bottom.Text:SetText("第 "..Page.." 页 / 共 "..MaxPage.." 页")
