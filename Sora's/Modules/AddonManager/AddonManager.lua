...
local Module = LibStub("AceAddon-3.0"):GetAddon("Sora"):NewModule("AddonManager")
...
local function BuildGameMenuButton(Tittle)
	...
	S.Reskin(Button)
	Button:SetSize(SoraGameMenuButton:GetWidth(), SoraGameMenuButton:GetHeight())
	Button:SetText("|cff70C0F5插件管理|r")
	Button:SetPoint("TOP", SoraGameMenuButton, "BOTTOM", 0, -1)
