...
local function UpdateObjects(frame)
	...
	frame.hp:SetSize(NameplateDB.HPWidth, NameplateDB.HPHeight)	
...
local function UpdateCastbar(frame)
	...
	frame.border:SetSize(NameplateDB.CastBarWidth, NameplateDB.CastBarHeight)
...
local function SkinObjects(frame)
	...
	hp.pct:SetFont(DB.Font, NameplateDB.Fontsize, "THINOUTLINE")
	...
	cbicon:SetSize(NameplateDB.CastBarIconSize, NameplateDB.CastBarIconSize)
	...
	name:SetFont(DB.Font, NameplateDB.Fontsize, "THINOUTLINE")
	frame.oldname = oldname
	frame.name = name
	
	frame.level = level
	level:SetFont(DB.Font, NameplateDB.Fontsize, "THINOUTLINE")
