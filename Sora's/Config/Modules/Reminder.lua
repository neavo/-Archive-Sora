...
DB.OptModules.Reminder = {}

-- LoadSettings
function DB.OptModules.Reminder.LoadSettings()
	local Default = {
		["RaidBuffSize"] = 18,
		["RaidBuffSpace"] = 4,
		["RaidBuffDirection"] = 1,
...
-- ResetToDefault
function DB.OptModules.Reminder.ResetToDefault()
	wipe(ReminderDB)
	C.Reminder.LoadSettings()
end

-- BuildGUI
function DB.OptModules.Reminder.BuildGUI()
	DB.OptTable["Reminder"] =  {
		type = "group",
		name = "增益缺失提醒",
		args = {
			Header_1 = {
