...
DB.OptModules.Nameplate = {}

-- LoadSettings
function DB.OptModules.Nameplate.LoadSettings()
	local Default = {
		["Fontsize"] = 10,						-- 姓名板字体大小
		["HPHeight"] = 5,						-- 姓名板血条高度
		["HPWidth"] = 120,						-- 姓名板血条宽度
...
-- ResetToDefault
function DB.OptModules.Nameplate.ResetToDefault()
	wipe(NameplateDB)
	DB.OptModules.Nameplate.LoadSettings()
end

-- BuildGUI
function DB.OptModules.Nameplate.BuildGUI()
	DB.OptTable["Nameplate"] =  {
		type = "group",
		name = "姓名板",
		args = {
			Fontsize = {
