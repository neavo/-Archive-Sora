...
-- BuildClass
DB.OptModules.ActionBar = CreateFrame("Frame")

-- LoadSettings
function DB.OptModules.ActionBar.LoadSettings()
	local Default = {
		["HideHotKey"] = false,
		["HideMacroName"] = true,
		["ShowExtraBar"] = true,
...
-- ResetToDefault
function DB.OptModules.ActionBar.ResetToDefault()
	wipe(ActionBarDB)
	C.ActionBar.LoadSettings()
end

-- BuildGUI
function DB.OptModules.ActionBar.BuildGUI()
	DB.OptTable["ActionBar"] =  {
		type = "group",
		name = "动作条",
		args = {
			HideHotKey = {
