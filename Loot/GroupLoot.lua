...
if not (GetLocale=="enGB" or GetLocale=="enUS") then
	...
	LOOT_ROLL_DISENCHANT = "%s 选择了分解：%s";
	LOOT_ROLL_DISENCHANT_SELF = "你 选择了分解：%s";
	LOOT_ROLL_GREED = "%s 选择了贪婪：%s";
	LOOT_ROLL_GREED_SELF = "你 选择了贪婪：%s";
	LOOT_ROLL_NEED = "%s 选择了需求：%s";
	LOOT_ROLL_NEED_SELF = "你 选择了需求：%s";
	LOOT_ROLL_PASSED = "%s 选择了放弃：%s";
	LOOT_ROLL_PASSED_AUTO = "%s 自动放弃了：%s ，因为他不能拾取这个物品。";
	LOOT_ROLL_PASSED_AUTO_FEMALE = "%s 自动放弃了：%s，因为她不能拾取这个物品。";
	LOOT_ROLL_PASSED_SELF = "你 选择了放弃：%s";
	LOOT_ROLL_PASSED_SELF_AUTO = "你 自动放弃了：%s，因为你不能拾取这个物品。";
	LOOT_ROLL_ROLLED_DE = "分解 -- %d for %s by %s";
