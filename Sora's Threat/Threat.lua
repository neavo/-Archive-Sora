...
local function Init()
	...
	Threat.Shadow = CreateFrame("Frame", nil, Threat)
	Threat.Shadow:SetFrameLevel(0)
	Threat.Shadow:SetPoint("TOPLEFT", -3, 3)
	Threat.Shadow:SetPoint("BOTTOMRIGHT", 3, -3)
	Threat.Shadow:SetBackdrop({edgeFile = cfg.GlowTex, edgeSize = 3})
...
-- 设置锚点
local function Pos()
	Threat:SetPoint(unpack(ThreatDB.Pos))
end
