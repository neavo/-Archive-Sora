...
function mod:SPELL_AURA_APPLIED(args)
	...
	elseif args:IsSpellID(88826) then
		...
		if mod:IsTank() or mod:IsHealer() then
			sndWOP:Play("Interface\\AddOns\\DBM-Core\\extrasounds\\doubleat.mp3")
		end
	...
	elseif args:IsSpellID(88853) then
		...
		sndWOP:Play("Interface\\AddOns\\DBM-Core\\extrasounds\\selffight.mp3")
		timerFailure:Start()
...
function mod:SPELL_CAST_START(args)
	if args:IsSpellID(82848) then
		...
		sndWOP:Schedule(15, "Interface\\AddOns\\DBM-Core\\extrasounds\\causticsoon.mp3")
...
function mod:SPELL_CAST_SUCCESS(args)
	...
	elseif args:IsSpellID(82934, 95524) then
		...
		sndWOP:Cancel("Interface\\AddOns\\DBM-Core\\extrasounds\\causticsoon.mp3")
