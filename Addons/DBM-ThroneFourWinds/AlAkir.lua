...
--			soundLightningRod:Play()
			sndWOP:Play("Interface\\AddOns\\DBM-Core\\extrasounds\\shockrun.mp3")
			if self.Options.RangeFrame then
...
function mod:SPELL_CAST_START(args)
	if args:IsSpellID(87770, 93261, 93262, 93263) then--Phase 1 wind burst
		...
		sndWOP:Play("Interface\\AddOns\\DBM-Core\\extrasounds\\windblast.mp3")
...
function mod:SPELL_DAMAGE(args)
	if args:IsSpellID(88858, 93286, 93287, 93288) and GetTime() - lastWindburst > 5 then--Phase 3 wind burst, does not use cast success :(
		...
		sndWOP:Schedule(16, "Interface\\AddOns\\DBM-Core\\extrasounds\\windblast.mp3")
...
function mod:CHAT_MSG_MONSTER_YELL(msg)
	...
	elseif msg == L.phase3 or msg:find(L.phase3) then
		...
		sndWOP:Schedule(21, "Interface\\AddOns\\DBM-Core\\extrasounds\\windblastsoon.mp3")
