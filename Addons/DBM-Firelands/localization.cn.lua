...
L:SetMiscLocalization({
	StaffEvent			= "诺达希尔木枝对于%S+的碰触产生了剧烈的反应!",--Reg expression pull match
	StaffTrees			= "燃烧的树人从地面冒出来协助保卫者!",--Might add a spec warning for this later.
	StaffTransition		= "受折磨的保卫者身上的火焰熄灭了!"
})
