...
local function valionaDelay()
	...
	sndWOP:Schedule(22, "Interface\\AddOns\\DBM-Core\\extrasounds\\breathsoon.mp3")
...
local function theralionDelay()
	...
	sndWOP:Cancel("Interface\\AddOns\\DBM-Core\\extrasounds\\breathsoon.mp3")
...
function mod:OnCombatStart(delay)
	...
	sndWOP:Schedule(22-delay, "Interface\\AddOns\\DBM-Core\\extrasounds\\breathsoon.mp3")
...
function mod:SPELL_AURA_APPLIED(args)
	if args:IsSpellID(86788, 92876, 92877, 92878) then
		...
		sndWOP:Play("Interface\\AddOns\\DBM-Core\\extrasounds\\blackout.mp3")
...
function mod:SPELL_CAST_START(args)
	if args:IsSpellID(86840, 90950) then--Strange to have 2 cast ids instead of either 1 or 4
		...
		sndWOP:Schedule(38, "Interface\\AddOns\\DBM-Core\\extrasounds\\breathsoon.mp3")
